...
const OperativeCard = ({ profile }: OperativeCardProps) => {
  return (
    <article className="matrix-flip group relative h-full rounded-2xl">
      <div className="matrix-flip-inner relative h-full w-full rounded-2xl">
        <div className="matrix-flip-face relative flex h-full flex-col overflow-hidden rounded-2xl border border-[var(--matrix-border)] bg-[var(--matrix-panel)]/70 p-5 shadow-[0_0_20px_rgba(58,149,255,0.2)] transition duration-300 group-hover:-translate-y-1 group-hover:border-[var(--matrix-accent)]">
